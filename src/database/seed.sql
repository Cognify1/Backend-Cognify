...
VALUES (1, 'Introducción a JS', 'Historia y usos de JavaScript.', 1, 10),
       (1, 'Variables y Constantes', 'Uso de var, let y const.', 2, 15),
       (1, 'Tipos de Datos', 'Strings, números y booleanos.', 3, 15),
       (1, 'Operadores Básicos', 'Operadores aritméticos y lógicos.', 4, 20),
       (1, 'Entrada y Salida', 'Uso de alert, prompt y console.log.', 5, 10);
